...
class EmotionPredictor:
    ...
    def _get_model(self):
        self._loaded_model_filename = '/Users/aiswarya/DataScienceArena/deep_dive_analytics/twitter_dashboard/TwitterEmotion/models/{}{}-{}.h5'.format(
    ...
    def _get_char_mapping():
        with open('/Users/aiswarya/DataScienceArena/deep_dive_analytics/twitter_dashboard/TwitterEmotion/models/allowed-chars.pkl', 'rb') as f:
